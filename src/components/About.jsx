...
export default function About() {
   return (
      <>
         <h2>Sobre <span>Emi Weather App</span>:</h2>
         <div className="contenedor-texto">
            <p>Esta web fue creada por <a href="https://github.com/Aglowkeys/">Emiliano Alfonso</a> utilizando <a href="https://reactjs.org">React JS</a>.</p>
